...
val Typography = Typography(
    ...
    headlineLarge = TextStyle(fontWeight = FontWeight.Normal, fontSize = 32.sp, letterSpacing = 0.sp),
    headlineMedium = TextStyle(fontWeight = FontWeight.Normal, fontSize = 28.sp, letterSpacing = 0.sp),
